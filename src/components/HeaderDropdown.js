...
import { removeUser } from '../util_function/userSlice'
...
export default function HeaderDropdown() {
  ...
  const navigate = useNavigate()
    ...
    const userIcon = <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-6 h-6">
